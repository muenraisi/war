...
func update_focus_neighbours(ignore=null):
	...
	for button in buttons_to_update:
		...
		button.focus_neighbor_left = button_previous
		button.focus_neighbor_right = button_next
		button.focus_neighbor_top = button_previous
		button.focus_neighbor_bottom = button_next
